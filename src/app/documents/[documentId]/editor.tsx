...
export const Editor = () => {
  ...
  return (
    <div className="h-screen flex flex-col overflow-hidden">
      ...
      {/* Fixed Navbar */}
      <nav className="w-full h-7 bg-gray-800 text-white flex items-center px-6 fixed top-0 left-0 z-50">
        <h1 className="text-xl font-bold">Real Time Collabrative Text Editor</h1>
      </nav>
